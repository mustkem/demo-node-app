...
$(document).ready(function () {
    ...
    $(".add-more-btn-rule").on("click",function(){
      ...
      var duplicate_content = $(".custom-order-details-content tbody tr")[0].outerHTML;
      console.log(duplicate_content);

      $(".custom-order-details-wrap .panel .custom-order-details-sec .custom-order-details-content tbody").append(duplicate_content);
     ...
     $('#cls-btn').hide();
      ...
      // elements.eq(0).find('a').addClass('hide-btn');
    ...
    $(".order-delete-btn").on("click",function(){
      ...
      $(".add-more-btn-rule").on("click",function(){
        ...
        $(".custom-order-details-wrap .panel .custom-order-details-sec").append(duplicate_content);
