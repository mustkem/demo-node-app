...
*/
//$baseUrl = 'http://10.0.4.21/ram/ckeditor-ckfinder-integration-master/uploads/';
$baseUrl ='http://10.0.4.21/ECOM/assets/text_editor/ckfinder/userfiles/';
//$baseDir = $_SERVER['DOCUMENT_ROOT'].'/CSS4110'.'/files/ckeditor/ckfinder/userfiles/';
$enabled = fakse;
/*
